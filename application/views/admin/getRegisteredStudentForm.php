   ...
   <h2 style="margin-left: 17px;margin-top: -20px;">Student Registered For Units</h2>                              
   <div class="getExam-form">
        <form role="form" id="StudentUnitform" method="post" action="<?php echo base_url(); ?>index.php/Home/Studentspdffile"> 
            <div class="box-body">
              <div class="col-md-6">
                  ...
                  <div class="form-group">
                   ...
                   <div class="col-md-6">
                       <div class="form-group">
                          ...
                          <select class="form-control select2" name="season" required="" style="width: 100%;">
                              <option selected="selected"></option>
                       ...
                       <div class="form-group">
                            ...
                            <select class="form-control select2" name="academicyear" required="" style="width: 100%;">
                                 <option selected="selected"></option>
             ...
             <button class="pull-right btn btn-primary">Get Students</button>
        </form>
 </div>
...
<script>
    ...
    /*  $("#StudentUnitform").submit(function(e){
   
                  e.preventDefault();
                  var formdata=$(this).serialize();
                  var base_url="http://localhost/UnitApp/";
                  $("#dashboard").load(base_url+"index.php/ManageUnits/ViewStudentRegisteredUnit",formdata);
      })*/
