                        ...
                        <div class="col-md-12">
                            <div class="panel well" style="margin-top: -62px;">
                                <img class="pic img-circle" src="assets/img/team/1.png" alt="...">
                                  <h3 style="margin-left: 213px;margin-top: -43px;">Welcome</h3>
                                <div class="name"><small>Simon Mumo</small></div>
                            </div>
                            <div class"mycontent"  style="background:#fff;margin-top: -21px;">

                            <form class="form-inline pull-right" style="margin:-70px -13px;">
                                      <div class="col-md-12">
                                          <div class="form-group">
                                              <label for="status">My Programme</label>
                                              <input type="text" class="form-control" style="width: 300px;" name="programme" placeholder="programme">
                                          </div>
                                        </div>
                           </form>

                                <br><br>
                                <ul class="nav nav-tabs pull-right right-bar"  id="side-bar" style="margin-top:-66px">
                                    <li class="active"><a href="javascript:void(0)" controller="ManageUnits" method="loadUnitRegisterform"><i class="fa fa-check"></i>Load Units</a></li>
                                    <li><a href="javascript:void(0)" controller="ManageStudents" method="profile"><i class="fa fa-user"> </i>My Profile</a></li>
                                    <li><a href="javascript:void(0)" controller="ManageStudents" method="finance"><i class="fa fa-briefcase"></i> My Finance</a></li>
                            ...
                            <div classs="main-content">
                                ...
                                <div class="row">       
                                      <div class="col-md-10 col-sm-12 col-md-offset-1" id="Content" style="margin-top:1px">
        ...
        <script>
            ...
            $(function(){
                      ...
                      $("#side-bar li a").click(function(){
                          ...
                          $("#Content").load("index.php/"+controller+"/"+method+"/"+data); 
