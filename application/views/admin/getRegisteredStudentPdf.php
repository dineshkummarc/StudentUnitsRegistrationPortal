...
class getRegisteredStudentPdf extends FPDF {
    var $CI;
...
function Header()
{
      // Logo
       ...
       // $this->Cell(200,70,'',1,'C');
        ...
        $this->Ln(10);
        $this->Cell(180,60,'Registered Students',0,0,'C');
         $this->Ln(40);
       ...
       /* $this->Cell(30,5,'Programme',1,0,'L');
        ...
        $this->cell(60,7,'RegNo',1,0,'',true);
        $this->cell(60,7,'First Name',1,0,'',true);
        $this->cell(60,7,'Last Name',1,1,'',true);
...
$this->Myfpdf=new getRegisteredStudentPdf ();
$this->Myfpdf->AliasNbPages();
$this->Myfpdf->AddPage();
//$this->Myfpdf->examcard($unit);
//$$this->Myfpdf->SetFont('Times','',12);
// $myq=" SELECT FIRSTNAME,LASTNAME FROM student INNER JOIN student_registered_units ON 'student.REGNO=student_registered_units.REGNO'";
...
/*while($data=mysqli_fetch_array($query)){
   // print_r($data);
        ...
        // $this->Myfpdf->cell(60,7,$data['LASTNAME'],1,1);
